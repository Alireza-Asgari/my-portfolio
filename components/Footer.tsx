...
export default function Footer() {
  return (
    <footer className="w-full mb-[100px] pb-10" id="contact">
      <div className="w-full absolute left-0 -bottom-72 minh-96">
        <img
          src="/footer-grid.svg"
          alt="grid"
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="text-white-200 md:mt-10 my-5 text-center">
          Reach out ot me today and let&apose;s discuss how I can help you
          achieve your goals.
        </p>
        <a href="mailto:alireza2023asgari@gamil.com">
          <MagicButton
